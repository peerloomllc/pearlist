...
// deterministic fixtures instead of the worklet (or the browser mock). Prepare
// the capture environment (dark theme, no tour, frozen clock) once, at import.
...
const mockMethods = {
  ...
  'shell:aiUnload': async () => { mock.ai = { ...mock.ai, state: 'idle' }; return { ok: true, status: mock.ai } },
